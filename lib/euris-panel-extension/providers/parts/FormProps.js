...
module.exports = function(group, element, bpmnFactory, workbench) {
    ...
    group.entries.push({
        ...
        set: function(element, values, node) {
            ...
            if (values.predefined === "true") {
                commands.push(cmdHelper.updateBusinessObject(element, bo, {'euris:predefined': true}));
                ...
                commands.push(cmdHelper.updateBusinessObject(element, bo, {'euris:predefined': false}));
                commands.push(cmdHelper.updateBusinessObject(element, bo, {'euris:formRef': ''}));
    ...
    group.entries.push(entryFactory.selectBox({
        ...
        set: function(element, values, node) {
            ...
            var commands = [];
            commands.push(cmdHelper.updateBusinessObject(element, bo, { 'euris:formRef': values.formRef }));
