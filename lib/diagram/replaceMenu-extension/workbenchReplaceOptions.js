...
module.exports.TASK = [
  ...
  {
     label: 'Portfolio services Task',
     actionName: 'replace-with-portfolio-task',
     className: 'bpmn-icon-portfolio',
     target: {
        type: 'bpmn:PortfolioTask'
     },
     strokeWidth: 0.5,

  },
  {
        label: 'Writing to portfolio Task',
        actionName: 'replace-with-portfolio-task',
        className: 'bpmn-icon-portfolio',
        target: {
            type: 'bpmn:WritingToPortfolioTask'
        },
        strokeWidth: 0.5,
