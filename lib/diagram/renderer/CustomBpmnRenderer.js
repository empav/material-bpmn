...
function BpmnRenderer(eventBus, styles, pathMap, canvas, priority) {
  ...
  var handlers = this.handlers = {
    ...
    'bpmn:WritingToPortfolioTask': function(parentGfx, element) {
        var attrs = {
            fill: '#5bacef',
            stroke: '#007ae5'
        };
        ...
        var DATA_STORE_PATH = pathMap.getScaledPath('DATA_STORE', {
            xScaleFactor: 1,
            yScaleFactor: 1,
            containerWidth: element.width/7,
            containerHeight: element.height/5,
            position: {
                mx: 0.5,
                my: 0.5
            }
        });
        drawPath(parentGfx, DATA_STORE_PATH, {
            strokeWidth: 1,
            fill: '#5bacef',
            stroke: '#007ae5'
        });
    ...
    'bpmn:PortfolioTask': function(parentGfx, element) {
      var attrs = {
        fill: '#BBDEFB',
        stroke: '#1E88E5'
      };
