...
var bpmnCamundaModdleExtension = require('../custom-panel-extension/providers/resources/camundaBpmnModdleExtension');
var bpmnModdleExtension = require('../custom-panel-extension/providers/resources/bpmnModdleExtension');
    ...
    DiagramManager.prototype.initBpmnDiagram = function () {
        ...
        var BpmnJS = BpmnModeler,
            additionalModules = [
                ...
                require('../custom-panel-extension'),
                {
...
*/
        ...
        this.renderer = new BpmnJS({
            ...
            moddleExtensions: {
                ...
                custom: require('../custom-panel-extension/providers/resources/custom')
            }
        });
